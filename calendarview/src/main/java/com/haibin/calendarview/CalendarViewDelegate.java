...
final class CalendarViewDelegate {
    ...
    private void init() {
        ...
        //添加农历今日
        int[] lunar = LunarUtil.solarToLunar(CalendarUtil.getDate("yyyy", d), CalendarUtil.getDate("MM", d), CalendarUtil.getDate("dd", d));
        mCurrentDate.setLunar(LunarCalendar.numToChinese(lunar[1], lunar[2], lunar[3]));
